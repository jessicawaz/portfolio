...
import "./About.css";
import { Section } from "../global/Section/Section.jsx";

const icons = [
  {
    title: "Node.js",
    icon: <i class="fab fa-node icon" />,
  ...
  {
    title: "React",
    icon: <i class="fab fa-react icon"></i>,
    link: "https://react.dev/",
  },
  {
    title: "JavaScript",
    icon: <i class="fab fa-js-square icon"></i>,
...
export const About = () => {
  ...
  const getSportsList = () => {
    axios
      .get("http://localhost:4000/listSports")
      .then((res) => {
        console.log(res);
      })
  ...
  return (
    <div className="about" id="about">
      <Section sectionClass="aboutWrapper">
        <div>
          <h1>About Me.</h1>
          <p>
            ...
            receiving a Bachelor's Degree in Software Engineering in May of
            2022.
          </p>
        </div>
          ...
          <div className="container">
            <div className="row iconsRow">
              {icons.map(({ title, icon, link }) => {
                return (
                  <div className="col-2 col-md-4 mb-4 iconCol">
